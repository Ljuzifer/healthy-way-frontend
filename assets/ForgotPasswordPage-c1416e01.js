import{v as c,s,k as x,o as d,j as a,F as p,m as l,B as h,_ as i,C as g,H as u}from"./index-ad94884c.js";import{S as w,H as b,a as j}from"./SignInPage.styled-786809b6.js";import{S as y,f}from"./SignInForm.styled-1a03b386.js";import{F,I as S,B as k,T as $}from"./SignUpImage.styled-fec6b55f.js";import{w as T,a as v,b as D,c as M,d as B,e as I}from"./watch-desk@2x-2cdfc254.js";const P=c.create({baseURL:"https://healthy-way-app.onrender.com"}),E=async o=>{try{const{data:e}=await P.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},H=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,W=s(y)`
